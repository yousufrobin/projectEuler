...
# this problem is also solved using dynamic programming method
...
print(f'''a) The maximum total from top to bottom of the triangle is {number[0][0]}.
b) It took {count} iterations and 
c) {time} seconds.''')